                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="filter_month" name="filter_month" class="form-control"
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="filter_year" name="filter_year" class="form-control"
    ...
    <script>
        ...
        $('#filter_month').datepicker({
            ...
            beforeShow: function(input, inst) {
                setTimeout(function() {
                    $(".ui-datepicker-calendar").hide(); // hide days
                    $(".ui-datepicker-year").hide(); // hide year

                    // jQuery bind change event only once
                    $(".ui-datepicker-month").off("change").on("change", function() {
                        var month = $(this).val();
                        var year = new Date().getFullYear();
                        $('#filter_month').datepicker('setDate', new Date(year, month, 1));
                        $('#filter_month').datepicker('hide'); // ✅ auto close
                    });
                }, 0);
            }
        });
        ...
        $('#filter_year').datepicker({
            ...
            beforeShow: function(input, inst) {
                setTimeout(function() {
                    ...
                    $(".ui-datepicker-year").off("change").on("change", function() {
                        var year = $(this).val();
                        $('#filter_year').val(year);
                        $('#filter_year').datepicker('hide');
                    });
                }, 0);
            }
        });
            ...
            dtable = $('#yajra-datatables').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.filter_year = $('input[name="filter_year"]').val();
