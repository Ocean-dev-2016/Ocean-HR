...
@push('page_scripts')
    <script type="text/javascript">
        ...
        $('#export_excel_btn').on('click', function(e) {
            ...
            let filter_country = $('select[name="country_id"] option:selected').val();
            let filter_state = $('select[name="state_id"] option:selected').val();
            let filter_city = $('select[name="city_id"] option:selected').val();
