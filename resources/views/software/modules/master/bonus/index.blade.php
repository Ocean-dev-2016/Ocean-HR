            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @endif
                        <div class="col-md-3 mb-2 col-sm-12 branchDiv" style="display:none;">
                            <div class="form-group">
...
@push('page_scripts')
    <script type="text/javascript">
            ...
            dtable = $('#yajra-datatables').DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        data.filter_branch = $('select[name="branch"] option:selected').val();
        ...
        $(document).on('focusout', '.displayorder-input', function() {
            let id = $(this).data('id');
            let display_order = $(this).val();
            var _token = '{{ csrf_token() }}';

            $.ajax({
                url: `{{ route('reference-master.update-displayorder') }}`,
                type: 'POST',
                data: {
                    _token: _token,
                ...
                error: function(xhr) {
                    ...
                    alert('Update failed: ' + xhr.statusText); // Shows "Not Found"
                }
            });
        });
