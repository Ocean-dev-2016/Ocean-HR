        ...
        <div class="col-md-12 mb-5" id="filter_section">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-label">Filter by Sub Department Name</label>
    ...
    <script type="text/javascript">
            ...
            dtable = $('#yajra-datatables').DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        data.filter_department = $('select[name="department_id"] option:selected')
                    .val();
        ...
        $('#export_excel_btn').on('click', function(e) {
           ...
           // Get all filter values
            ...
            let department = $('#department_id').val(); // new department filter
        ...
        $('#print_btn').on('click', function(e) {
            ...
            // Open the print page with all filters applied
