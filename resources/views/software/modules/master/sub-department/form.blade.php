                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input id="sub_department_name" type="text"
                                class="form-control @error('sub_department_name') is-invalid @enderror"
                                name="sub_department_name"
                                value="{{ isset($edit) && $edit?->sub_department_name ? $edit?->sub_department_name : old('sub_department_name') }}"
