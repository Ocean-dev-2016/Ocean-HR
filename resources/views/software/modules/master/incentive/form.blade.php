            ...
            <form
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 mb-2">
                        <div class="form-group">
                            ...
                            <select id="employee_id"
                                class="form-control select2 search_by_employeedetails @error('employee_id') is-invalid @enderror"
                                name="employee_id"
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-group">
                            <label class="form-label"> Incentive Value (%) <span class="text-danger">*</span> </label>
                            <input id="incentive_value" type="number"
                                class="form-control @error('incentive_value') is-invalid @enderror" name="incentive_value"
                                value="{{ isset($edit) && $edit?->incentive_value ? $edit?->incentive_value : old('incentive_value') }}"
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-group">
                            <label class="form-label"> Incentive Amount<span class="text-danger">*</span> </label>
                            <input id="incentive_amount" type="number"
                                class="form-control @error('incentive_amount') is-invalid @enderror" name="incentive_amount"
                                value="{{ isset($edit) && $edit?->incentive_amount ? $edit?->incentive_amount : old('incentive_amount') }}"
...
@push('page_scripts')
    ...
    @include('utils.getEmployeeDetails')
@endpush
