        ...
        <div class="col-md-12 mb-5" id="filter_section">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-label">Filter by Process Name</label>
                        ...
                        <div class="col-md-3 mb-2 col-sm-12">
                            <div class="form-group">
                                <label class="form-label">Filter by Sub Department</label>
                                <select id="sub_department_id" name="sub_department_id"
                                    class="form-control search_by_subdepartment select2 select_filter"
                                    data-append="search_by_department">
                                    <option value="">Filter by Sub Department</option>
                                </select>
                            </div>
                        </div>
            ...
            dtable = $('#yajra-datatables').DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        data.filter_subdepartment = $('select[name="sub_department_id"] option:selected').val();
