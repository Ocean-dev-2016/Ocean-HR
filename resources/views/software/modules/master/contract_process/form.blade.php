        ...
        <div class="card-body">
            <form
                ...
                <div class="row">
                    ...
                    {{-- Contract Process Name --}}
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-group">
                            <label class="form-label"> Contract Process Name <span class="text-danger">*</span> </label>
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                name="name" value="{{ isset($edit) && $edit?->name ? $edit?->name : old('name') }}"
                                placeholder="Enter Contract Process Name">
                            @error('name')
                                <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input id="rate" type="number" step="0.01" class="form-control @error('rate') is-invalid @enderror"
                                name="rate" value="{{ isset($edit) && $edit?->rate ? $edit?->rate : old('rate', '0.00') }}"
