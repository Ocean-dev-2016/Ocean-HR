...
@section('title', 'Punch-In Record Report')
...
@php
    ...
    $yearCol = !$company_id ? 'col-md-2' : 'col-md-3';
    $monthCol = !$company_id ? 'col-md-2' : 'col-md-3';
    $employeeCol = !$company_id ? 'col-md-3' : 'col-md-4';
    $buttonCol = !$company_id ? 'col-md-2' : 'col-md-2';
@endphp

@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">Punch-In Record Report</h5>
            <form id="filterForm">
                @csrf
                <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                    ...
                    <div class="{{ $buttonCol }} mb-2 d-flex align-items-center gap-2">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#getReportBtn').click(function () {
                ...
                $.ajax({
                    url: "{{ route('punch-in-record-report.getReport') }}",
                    type: "POST",
                    data: form.serialize(),
                    success: function (response) {
            ...
            $('#printBtn').click(function () {
                ...
                var url = "{{ route('punch-in-record-report.print') }}?" + form.serialize();
            ...
            $('#exportBtn').click(function () {
                ...
                var url = "{{ route('punch-in-record-report.export-excel') }}?" + form.serialize();
                window.open(url, '_blank');
            });
        });
    </script>
