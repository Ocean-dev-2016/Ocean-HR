...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">Miss Punch Report</h5>
            <form id="filterForm">
                @csrf
                <div class="row pb-2 align-items-center">
                    ...
                    <div class="col-md-2 mb-2">
                        <input type="date" id="date" name="date" class="form-control"
                            title="Specific Date (Overrides Month/Year)">
                    </div>
                    <div class="col-md-2 mb-2">
    ...
    <script>
        $(document).ready(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.status && response.data) {
                                // Response is grouped by Department: { "DeptName": [ {id, full_name}, ... ] }
                                $.each(response.data, function (deptName, employees) {
                                    // Optional: Add optgroup for departments
            ...
            $('#getReportBtn').click(function () {
                ...
                $.ajax({
                    url: "{{ route('miss-punch-report.getReport') }}",
                    type: "POST",
                    data: form.serialize(),
                    success: function (response) {
            ...
            $('#printBtn').click(function () {
                ...
                var url = "{{ route('miss-punch-report.print') }}?" + form.serialize();
            ...
            $('#exportBtn').click(function () {
                ...
                var url = "{{ route('miss-punch-report.export-excel') }}?" + form.serialize();
                window.open(url, '_blank');
            });
        });
    </script>
