...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">Late Punch Report</h5>
            <form id="filterForm">
                @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#getReportBtn').click(function () {
                ...
                $.ajax({
                    url: "{{ route('late-punch-report.getReport') }}",
                    type: "POST",
                    data: form.serialize(),
                    success: function (response) {
            ...
            $('#printBtn').click(function () {
                ...
                var url = "{{ route('late-punch-report.print') }}?" + form.serialize();
            ...
            $('#exportBtn').click(function () {
                ...
                var url = "{{ route('late-punch-report.export-excel') }}?" + form.serialize();
                window.open(url, '_blank');
            });
