        ...
        <div class="col-md-12 mb-5" id="filter_section">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-label">Filter by From / To Employee Name</label>
...
@push('page_scripts')
    <script type="text/javascript">
        ...
        $(document).on('focusout', '.displayorder-input', function() {
            ...
            $.ajax({
                url: `{{ route('assets-allocation-master.update-displayorder') }}`,
                type: 'POST',
                data: {
                    _token: _token,
    ...
    @include('software.inlcudes.script-ajax-call')
@endpush
