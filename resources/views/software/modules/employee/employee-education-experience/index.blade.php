            ...
            dtable = $('#yajra-datatables').DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        data.filter_department_name = $(
                            'select[name="department_name"] option:selected').val();
                        data.filter_designation_name = $(
                            'select[name="designation_name"] option:selected').val();
                        data.filter_document_type = $('select[name="document_type"] option:selected')
                            .val();
