        ...
        <div class="col-md-12 mb-5" id="filter_section">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-label">Filter by Assets Name</label>
            ...
            function initDateRangePicker(selector) {
                if ($(selector).length > 0) {
                    $(selector).daterangepicker({
                        ...
                        dtable && dtable.draw(); // redraw table immediately when date is selected
                    });

                    $(selector).on('cancel.daterangepicker', function() {
                        $(this).val('');
                        dtable && dtable.draw(); // redraw table on clear
                    });
                }
            }
