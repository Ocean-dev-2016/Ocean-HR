              ...
              dom: '<"table-responsive"t><"datatable-footer d-flex justify-content-between align-items-center flex-wrap px-3 py-2"l i p>',
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        let filter_company_id = null;
                        if ($('select[name="company_id"] option:selected').val()) {
                            filter_company_id = $('select[name="company_id"] option:selected').val();
                        }
                        data.filter_company = filter_company_id;
                    },
                },
