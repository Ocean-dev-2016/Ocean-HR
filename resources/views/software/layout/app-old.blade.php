...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('software/vendor/css/rtl/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('software/vendor/css/rtl/theme-default.css') }}" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="{{ asset('software/vendor/libs/swiper/swiper.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('software/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}" />

    <!-- Page CSS -->
    <link rel="stylesheet" href="{{ asset('software/vendor/css/pages/cards-advance.css') }}" />
...
<body>
    ...
    <script src="{{ asset('software/vendor/libs/swiper/swiper.js') }}"></script>
    ...
    <!-- Page JS -->
    <script src="{{ asset('software/js/dashboards-analytics.js') }}"></script>
</body>
