...
class AssetsAllocationMasterExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    protected $srNo = 1;
    ...
    {
        $query = AssetsAllocationMaster::with('company');
