...
class ContractorLeaveApplicationController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->modules = [
            'title' => 'Contractor Leave Application',
            'folder_path' => 'software.modules.contractor.leave-application',
            'route' => 'contractor-leave-application',
            'table_name' => (new LeaveApplication())->getTable(),
            'permisstion_prefix' => 'contractor-leave-application',
            'module_name' => 'Contractor Leave Application',
