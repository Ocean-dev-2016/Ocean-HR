...
class DesignationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->modules = [
            'title' => 'Designation',
            'folder_path' => 'software.modules.designation',
            'route' => 'designation',
            'table_name' => (new Designation())->getTable(),
            'permisstion_prefix' => 'designation',
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            if ($request->ajax()) {
                ...
                $data->where(function ($q1) use ($modules, $loginUserId) {
    ...
    public function edit(string $id)
    {
        ...
        try {
            View::share('modules', $modules);
            $desQuery = Designation::query();
            if (!empty($modules['company_id'])) {
                $desQuery->where('company_id', $modules['company_id']);
            }
            $edit = $desQuery->findOrFail($id);
    ...
    public function update(DesignationRequest $request, string $id)
    {
        ...
        try {
            ...
            $updateData = $desQuery->findOrFail($id);
            if ($updateData) {
                unset($validated['id']);
    ...
    public function destroy(Request $request, string $id)
    {
        ...
        $dataDelete = $desQuery->findOrFail($id);
    ...
    public function status_update(Request $request)
    {
        ...
        try {
            $desQuery = Designation::withTrashed();
            if (!empty($modules['company_id'])) {
                $desQuery->where('company_id', $modules['company_id']);
            }
            $designation = $desQuery->findOrFail($request?->id);
            if ($designation) {
    ...
    public function restore($id)
    {
        ...
        try {
            ...
            $designation = $desQuery->findOrFail($id);
            $designation->restore();
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(
            new DesignationExport($request->all(), $this->authenticateLoginUserDetails,$modules),
            'Designation-' . Helper::convert_date("", "Y-m-d H:i:s", "Ymd-His") . '.xlsx'
        );
    }
    ...
    public function print(Request $request)
    {
        ...
        try {
            ...
            return view($modules['folder_path'] . '.print', compact('designation', 'company_id', 'modules'));
        } catch (\Exception $e) {
            return Redirect::route($modules['route'] . '.index')->withErrors($e->getMessage());
        }
    }
