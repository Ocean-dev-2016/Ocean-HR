...
class ProcessController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->modules = [
            'title' => 'Process',
            'folder_path' => 'software.modules.master.process',
            'route' => 'process',
            'table_name' => (new Process())->getTable(),
            'permisstion_prefix' => 'process',
            'module_name' => 'Process',
    ...
    public function index(Request $request)
    {
        ...
        try {
            $columns = [
                ...
                (object)['data' => "subdepartment.sub_department_name", 'name' => 'sub_department_id', 'td_label' => 'Sub Department Name', 'className' =>  ''],

                (object)['data' => "name", 'name' => 'name', 'td_label' => 'Process Name', 'className' =>  ''],
            ...
            if ($request->ajax()) {
                ...
                $data = $data->with(['company', 'department', 'subdepartment']);
    ...
    public function edit(string $id)
    {
        ...
        try {
            ...
            if (!empty($modules['company_id'])) {
                $processQuery->where('company_id', $modules['company_id']);
            }
            $edit = $processQuery->findOrFail($id);
    ...
    public function update(ProcessRequest $request, string $id)
    {
        ...
        try {
            ...
            $updateData = $processQuery->findOrFail($id);
            if ($updateData) {
                unset($validated['id']);
    ...
    public function destroy(string $id, Request $request)
    {
        ...
        $dataDelete = $processQuery->findOrFail($id);
    ...
    public function restore($id)
    {
        ...
        try {
            ...
            $processQuery = Process::withTrashed();
            if (!empty($modules['company_id'])) {
                $processQuery->where('company_id', $modules['company_id']);
            }
            $restore_data = $processQuery->findOrFail($id);
    ...
    public function status_update(Request $request)
    {
        ...
        try {
            ...
            $country = $processQuery->findOrFail($request?->id);
            if ($country) {
