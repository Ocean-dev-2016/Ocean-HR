...
class ContractorEmployementDetailController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->modules = [
            'title' => 'Contractor Employment Details',
            'folder_path' => 'software.modules.contractor.employment-details',
            'route' => 'contractor-employment-details',
            'table_name' => (new EmploymentDetail())->getTable(),
            'permisstion_prefix' => 'contractor-employment-details',
            'module_name' => 'Contractor Employment Details',
    ...
    public function print(Request $request)
    {
        ...
        try {
            ...
            // Department filter
            $departmentId = $request->input('department') ?? $request->input('filter_department');
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new EmploymentDetailExport($request->all(), $this->authenticateLoginUserDetails, $modules), 'Contractor Employment Details-' . Helper::convert_date("", "Y-m-d H:i:s", "Ymd-His") . '.xlsx');
    }
}
