...
class SalaryController extends Controller
{
    ...
    public function update(SalaryRequest $request, string $id)
    {
        ...
        try {
            ...
            $updateData = Salary::findOrFail($id);
    ...
    public function destroy(string $id, Request $request)
    {
        ...
        $dataDelete = Salary::findOrFail($id);
    ...
    public function restore($id)
    {
        ...
        try {
            $restore_data = Salary::withTrashed()->findOrFail($id);
    ...
    public function status_update(Request $request)
    {
        ...
        try {
            $country = Salary::withTrashed()->findOrFail($request?->id);
            if ($country) {
