...
class DepartmentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->modules = [
            ...
            'folder_path' => 'software.modules.master.department',
            'route' => 'departments',
            'table_name' => (new Department())->getTable(),
            'permisstion_prefix' => 'Main Department',
            'module_name' => 'Main Department',
                ...
                $data = Department::select('*')
                    ->where(function ($query) use ($modules, $loginUserId) {
                        if (Auth::guard('employees')->check() || !empty($modules['company_id'])) {
                            ...
                            $query->where((new Department())->getTable() . '.company_id', $companyId);

                            if ($modules['personal_data_permission'] && $modules['all_data_permission'] == false) {
                                $query->where((new Department())->getTable() . '.created_by', $loginUserId);
                            }
                        }
                    })
                    ->orderBy('id', 'DESC');
    ...
    public function edit(string $id)
    {
        ...
        try {
            ...
            if (!empty($modules['company_id'])) {
                $deptQuery->where('company_id', $modules['company_id']);
            }
            $edit = $deptQuery->findOrFail($id);
    ...
    public function update(DepartmentRequest $request, string $id)
    {
        ...
        try {
            ...
            $updateData = $deptQuery->findOrFail($id);
            if ($updateData) {
                unset($validated['id']);
    ...
    public function destroy(Request $request, string $id)
    {
        ...
        $dataDelete = $deptQuery->findOrFail($id);
    ...
    public function restore($id)
    {
        ...
        try {
            ...
            $deptQuery = Department::withTrashed();
            if (!empty($modules['company_id'])) {
                $deptQuery->where('company_id', $modules['company_id']);
            }
            $restore_data = $deptQuery->findOrFail($id);
    ...
    public function status_update(Request $request)
    {
        ...
        try {
            ...
            $country = $deptQuery->findOrFail($request?->id);
            if ($country) {
    ...
    public function print(Request $request)
    {
        ...
        try {
            ...
            return view($modules['folder_path'] . '.print', compact('department', 'company_id', 'modules'));
        } catch (\Exception $e) {
            return Redirect::route($modules['route'] . '.index')->withErrors($e->getMessage());
        }
    }
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new DepartmentExport($request->all(), $this->authenticateLoginUserDetails, $modules), 'Department-' . Helper::convert_date("", "Y-m-d H:i:s", "Ymd-His") . '.xlsx');
    }
}
